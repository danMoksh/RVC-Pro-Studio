    ...
    const tuningArea = useMemo(() => {
        ...
        return (
            <div className="character-area-control">
                <div className="character-area-control-title"><a className="hint-text" data-tooltip-id="hint" data-tooltip-content="Pitch shift alters the tone of voice. If your voice is low-pitched and the model is high-pitched, increase this setting (i.e., set to 12). Otherwise, decrease this setting (i.e., set to -12).">PITCH</a>:</div>
